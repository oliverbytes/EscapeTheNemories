...
public static class Uni2DEditorUtilsContourPolygonization
{
		...
		foreach( Contour rOuterContour in a_rOuterContours )
		{
			...
			foreach( Contour rInnerContour in a_rInnerContours )
			{
				if( rInnerContour.Region == rMergedContour.Region )
				{
					...
					rMergedContour = Uni2DEditorUtilsPolygonTriangulation.InsertInnerContourIntoOuterContour( rMergedContour, rInnerContour );
				}
